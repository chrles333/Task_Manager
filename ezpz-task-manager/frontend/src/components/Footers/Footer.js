/** This component displays a footer for the Index page
 */
          ...
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="w-full lg:w-6/12 px-4">
              ...
              <div className="mt-6 lg:mb-0 mb-6">
                ...
                <button
                  className="bg-white text-col-dark shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-2"
                  type="button"
                >
              ...
              <div className="flex flex-wrap items-top mb-6">
                <div className="w-full lg:w-4/12 px-4 ml-auto">
                  ...
                  <ul className="list-unstyled">
                    <li>
                      <p
                        className="text-slate-600 hover:text-col-dark font-semibold block pb-2 text-sm"
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-slate-500 font-semibold py-1">
                Copyright © {new Date().getFullYear()} EzPz by{" "}
                <p
                 
                  className="text-slate-500 hover:text-col-dark"
                >
                  EzPz
                </p>
                .
