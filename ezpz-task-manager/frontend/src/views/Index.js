...
export default function Index() {
  ...
  cursorEmpty = document.querySelectorAll(['h2', 'h3', 'img'])

  cursorEmpty.forEach(link => {
  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden text-center bg-no-repeat flip"> 
        <svg width="12" height="3000" viewBox="0 0 12 3000" fill="none" preserveAspectRatio="xMidYMax meet">
          <path d="M6 3000L6 0" stroke="url(#paint0_linear_2_15)" strokeWidth="12"/>
          <defs>
          <linearGradient id="paint0_linear_2_15" x1="4.46099e+14" y1="3264.3" x2="4.46099e+14" y2="-110.709" gradientUnits="userSpaceOnUse">
          <stop offset="0.296875" stop-color="#751EFF"/>
        ...
        <div className="container mx-auto items-center flex flex-wrap">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-extrabold text-9xl bg-gradient-to-r from-cyan-500 to-blue-500  bg-clip-text text-transparent">
                EzPz
              </h2>
              <h3 className="font-semibold text-6xl text-slate-600">
              ...
              <div className="mt-12">
                <Link
                  to="/auth/login"
                  className="get-started text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 uppercase text-sm shadow hover:shadow-lg ease-in-out transition-all duration-700 delay-700 bg-gradient-to-r from-cyan-500 to-blue-600 " 
                  target="_blank"              >
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-slate-100">
        ...
        <div className="container mx-auto">
          <div className="flex flex-wrap items-center">
            <div className="w-10/12 md:w-6/12 lg:w-4/12 px-12 md:px-4 mr-auto ml-auto -mt-60">
